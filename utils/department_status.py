...
# ─── Department Status ──────────────────────────────────────────────────────
# True  = ✅ Working (fully functional)
# False = ❌ Under Construction (shows popup when clicked)
DEPARTMENT_STATUS: Dict[str, bool] = {
    ...
    # ── Patient Services ──
    "Patient History": True, # ✅ Working
    "Patient Portal": True,  # ✅ Working
    "Patient Timeline": True,# ✅ Working
    "Patient Tracking": True,# ✅ Working
    "Emergency":    True,    # ✅ Working
    "IPD Ward":     True,    # ✅ Working
...
def get_status_badge(module_name: str) -> str:
    ...
    if working:
        return '<span style="background:#00b894;color:white;padding:2px 8px;border-radius:10px;font-size:0.7rem;font-weight:bold;">✅ LIVE</span>'
    else:
        return '<span style="background:#d63031;color:white;padding:2px 8px;border-radius:10px;font-size:0.7rem;font-weight:bold;">❌ Under Construction</span>'
...
function showUnderConstruction(name) {
    ...
    overlay.innerHTML = `
        <div style="background: white; border-radius: 20px; padding: 2.5rem 2rem;
            ...
            <h2 style="color: #d63031; margin-bottom: 0.5rem; font-size: 1.5rem;">Under Construction</h2>
            <p style="color: #636e72; margin-bottom: 1.5rem; font-size: 1rem;">
                <strong style="color:#2d3436;">${name}</strong> module abhi develop ho raha hai.<br>
                Jald hi available hoga! 🔧
            </p>
            <div style="background: #ffeaa7; padding: 0.8rem; border-radius: 10px; margin-bottom: 1.5rem;">
                <span style="color: #d63031; font-size: 0.9rem;">⏳ Coming Soon</span>
            </div>
